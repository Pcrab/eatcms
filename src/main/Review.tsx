  ...
  return <>
    <div>
      ...
      {pagination}
      {
        ...
        <div className="absolute top-0 left-0 w-full h-full" style={{backgroundColor: "rgba(0,0,0,0.65)"}}
          onClick={() => {
            setVisible(false);
          }}>
          <div className="flex mx-auto my-24 pr-6 py-8 rounded-3xl bg-white"
